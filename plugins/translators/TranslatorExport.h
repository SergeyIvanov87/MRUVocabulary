...
long long                       TRANSLATE_PLUGIN_FUNC                  (plugin_ctx_t* in_translator_ctx, shared_decoded_data_t* in_decoder_session, session_t *out_translator_session);
char*                           SHARED_CTX_2_STRING_FUNC               (plugin_ctx_t* in_translator_ctx, session_t* in_translator_session);

typedef long long                    (*translate_data_ptr)             (plugin_ctx_t* in_translator_ctx, shared_decoded_data_t* in_decoder_session, session_t *out_translator_session);
